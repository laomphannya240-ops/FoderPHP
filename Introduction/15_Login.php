...
<body>
   <form action="15Check_role.php" class="mt-4 m-auto p-4 shadow rounded-3 w-25" method="POST">
    ...
    <button class="mt-3 btn btn-primary w-100 " name="btnlogin">Login</button>

    <div class="mt-2 text-center">
    <span>Already have accounts?</span>    
    <a href="./15_register.php">register</a>
</div>
   </form>
</body>
</html>